...
(
  ...
  "this <cycle>"
  [#"(?i)te(mu|n|go|j)|tym|t(a|ą)|przysz(l|ł)(ym|y|emu|ego|(a|ą)|ej)|nadchodz(a|ą)c(ym|y|ego|emu|(a|ą)|ej)|obecn(ym|y|emu|ego|nym|(a|ą)|ej)" (dim :cycle)]
  (cycle-nth (:grain %2) 0)
  ...
  "next <cycle>"
  [#"(?i)kolejn(ym|y|ego|emu|(a|ą)|ej|e)|nast(e|ę)pn(ym|y|ego|emu|(a|ą)|ej|e)" (dim :cycle)]
  (cycle-nth (:grain %2) 1)
