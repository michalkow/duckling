(
  ...
  "named-day"
  #"(?i)poniedziałek|poniedzialek|poniedziałku|poniedzialku|poniedziałkowi|poniedzialkowi|poniedziałkiem|poniedzialkiem|poniedziałku|poniedzialku|pon\.?"
  (day-of-week 1)
  ...
  "named-day"
  #"(?i)(Ś|ś|s)rod(a|ą|y|e|ę|zie|o)|(s|ś|Ś)ro?\.?"
  (day-of-week 3)
  ...
  "named-day"
  #"(?i)piątek|piatek|piątku|piatku|piątkowi|piatkowi|piątkiem|piatkiem|pia\.?"
  (day-of-week 5)
 ...
 #"(?i)styczeń|styczen|stycznia|styczniowi|styczniem|styczniu|sty(cz)?\.?"
  ...
  "christmas"
  #"(?i)(xmas|christmas|boże narodzenie|bożego narodzenia|boze narodzenie|bozego narodzenia)( day)?"
  (month-day 12 25)

  "christmas eve"
  #"(?i)wigilia|wigilii|wigili(e|ę)|wigili(a|ą)|wigilio"
  (month-day 12 24)
  ...
  #"(?i)thanks?giving( day)?|((s|ś)wiet(a|o)|(dzie(n|ń))) dzi(e|ę)kczynienia"
  ...
  "tomorrow"
  #"(?i)jutr(o|a|u|em|ze(jszy)?)|jtr|jutr"
 (cycle-nth :day 1)
 ...
 (cycle-nth :day 2)
  ...
  "this <time>"
  [#"(?i)te(mu|n|go)|ta|to|tym|przysz(l|ł)(ym|y|emu|ego|(a|ą)|ej)|nadchodz(a|ą)c(ym|y|ego|emu|(a|ą)|ej)" (dim :time)]
  (pred-nth %2 0)

  "next <time>"
  [#"(?i)kolejn(ym|y|ego|emu|(a|ą)|ej|e)|nast(e|ę)pn(ym|y|ego|emu|e|(a|ą)|ej|e)" (dim :time #(not (:latent %)))]
  (pred-nth-not-immediate %2 0)
 ...
 (hour (:value %1) true)
  ...
  "noon"
  #"(?i)po(l|ł)udni(a|e)" ;;TODO REPLACE
  (hour 12 false)
 ...
 ;;TODO IMPLEMENT W POL DO XX
  ...
  [#"(?i)rano|poranku|z rana|(s|ś)witem"]
  ...
  [#"(?i)o?ko(l|ł)o|mniej wi(e|ę)cej" {:form :time-of-day}]
  (-> %2
    (dissoc :latent)
    (merge {:precision "approximate"}))
  ...
  [(dim :time #(not (:latent %))) #"\-|do|po|aż do|az do|aż po|az po" (dim :time #(not (:latent %)))]
  (interval %1 %3 true)
  ...
  "until <time-of-day>"
  [#"(?i)(anytime |sometimes? )?(before|until|through|up to)?do" (dim :time)]
